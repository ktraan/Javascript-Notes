 ...
 * @constructor
 * @param {Object} attrs - options to set on the Weather object
 * @param {string} attrs.city - the city that this Weather object is being created for (default to 'edmonton')
 * @param {function} attrs.template - the template function to use for rendering the weather
 */
const Weather = function (attrs) {
	 ...
	 */
	this.getWeatherAndForecast = function () {
