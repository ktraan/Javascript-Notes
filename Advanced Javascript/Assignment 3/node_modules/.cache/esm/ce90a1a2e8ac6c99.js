let mocha,chai,chaiAsPromissed,fetchMock,Stock,ENDPOINT,API_KEY;_e8a‍.w("mocha",[["default",["mocha"],function(v){mocha=v}]]);_e8a‍.w("chai",[["default",["chai"],function(v){chai=v}]]);_e8a‍.w("chai-as-promised",[["default",["chaiAsPromissed"],function(v){chaiAsPromissed=v}]]);_e8a‍.w("fetch-mock",[["default",["fetchMock"],function(v){fetchMock=v}]]);_e8a‍.w("../js/src/stock.js",[["Stock",["Stock"],function(v){Stock=v}],["ENDPOINT",["ENDPOINT"],function(v){ENDPOINT=v}],["API_KEY",["API_KEY"],function(v){API_KEY=v}]]);// Test suite for the Stock module
